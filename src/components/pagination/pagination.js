...
import MzSelect from '@/components/select/mz-select';
import MzOption from '@/components/select/mz-option';
...
export default {
  ...
  render(h) {
    let template = <div class={['mz-pagination', {
      'is-background': this.background,
      'mz-pagination--small': this.small
    }] }></div>;
    ...
    const rightWrapper = <div class="mz-pagination__rightwrapper"></div>;
  ...
  components: {
          ...
          <button
            ...
            on-click={ this.$parent.prev }>
            {
              this.$parent.prevText
                ...
                : <i class="mz-icon mz-icon-arrow-left"></i>
            }
          </button>
        );
      }
          ...
          <button
            ...
            on-click={ this.$parent.next }>
            {
              this.$parent.nextText
                ...
                : <i class="mz-icon mz-icon-arrow-right"></i>
            }
          </button>
        );
      }
    ...
    Sizes: {
      ...
      render(h) {
        return (
          <span class="mz-pagination__sizes">
            <mz-select
    ...
    Jumper: {
      ...
      render(h) {
        return (
          <span class="mz-pagination__jump">
            { this.t('mz.pagination.goto') }
            <mz-input
              class="mz-pagination__editor is-in-pagination"
              min={ 1 }
            ...
            { this.t('mz.pagination.pageClassifier') }
          </span>
        );
      }
    },
      ...
      render(h) {
        return (
          typeof this.$parent.total === 'number'
            ? <span class="mz-pagination__total">{ this.t('mz.pagination.total', { total: this.$parent.total }) }</span>
            : ''
        );
      }
    },
