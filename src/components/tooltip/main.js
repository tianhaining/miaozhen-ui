...
export default {
  ...
  render(h) {
      ...
      this.popperVM.node = (
        <transition
          ...
          <div
            ...
            class={
              ['mz-tooltip__popper', 'is-' + this.effect, this.popperClass]
            }>
    ...
    data.staticClass = this.concatClass(data.staticClass, 'mz-tooltip');
