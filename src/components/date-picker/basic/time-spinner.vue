<template>
  <div class="mz-time-spinner" :class="{ 'has-seconds': showSeconds }">
    <template v-if="!arrowControl">
      <mz-scrollbar
        @mouseenter.native="emitSelectRange('hours')"
        @mousemove.native="adjustCurrentSpinner('hours')"
        class="mz-time-spinner__wrapper"
        wrap-style="max-height: inherit;"
        view-class="mz-time-spinner__list"
        noresize
        tag="ul"
        ref="hours">
        <li
    ...
    <template v-if="arrowControl">
      <div
        ...
        class="mz-time-spinner__wrapper is-arrow">
        <i v-repeat-click="decrease" class="mz-time-spinner__arrow mz-icon-arrow-up"></i>
        <i v-repeat-click="increase" class="mz-time-spinner__arrow mz-icon-arrow-down"></i>
        <ul class="mz-time-spinner__list" ref="hours">
          <li
            class="mz-time-spinner__item"
      ...
      <div
        ...
        <i v-repeat-click="decrease" class="mz-time-spinner__arrow mz-icon-arrow-up"></i>
        <i v-repeat-click="increase" class="mz-time-spinner__arrow mz-icon-arrow-down"></i>
        <ul class="mz-time-spinner__list" ref="minutes">
          <li
            class="mz-time-spinner__item"
      ...
      <div
        ...
        <i v-repeat-click="decrease" class="mz-time-spinner__arrow mz-icon-arrow-up"></i>
        <i v-repeat-click="increase" class="mz-time-spinner__arrow mz-icon-arrow-down"></i>
        <ul class="mz-time-spinner__list" ref="seconds">
          <li
            class="mz-time-spinner__item"
