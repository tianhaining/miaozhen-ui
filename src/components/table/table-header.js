              ...
              >
              {
                this._l(columns, (column, cellIndex) =>
                  <th
                    ...
                    {
                      column.filterable
                         ? <span class="mz-table__column-filter-trigger" on-click={ ($event) => this.handleFilterClick($event, column) }><i class={ ['mz-icon-arrow-down', column.filterOpened ? 'mz-icon-arrow-up' : ''] }></i></span>
                        : ''
                    }
                    </div>
                  </th>
