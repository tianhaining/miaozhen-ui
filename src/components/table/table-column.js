...
const defaults = {
  ...
  selection: {
    ...
    realWidth: 48,
    order: '',
    className: 'mz-table-column--selection'
  },
  expand: {
    width: 48,
    minWidth: 48,
...
const forced = {
  ...
  expand: {
    ...
    renderCell: function(h, { row, store }, proxy) {
      ...
      return <div class={ 'mz-table__expand-icon ' + (expanded ? 'mz-table__expand-icon--expanded' : '') }
    ...
    sortable: false,
    resizable: false,
    className: 'mz-table__expand-column'
  }
};
  ...
  created() {
    ...
    column.renderCell = function(h, data) {
      ...
      return _self.showOverflowTooltip || _self.showTooltipWhenOverflow
        ? <div class="cell mz-tooltip" style={'width:' + (data.column.realWidth || data.column.width) + 'px'}>{ renderCell(h, data) }</div>
