<script>
  import MzTabBar from './mz-tab-bar';
  ...
  export default {
    ...
    render(h) {
      ...
      const scrollBtn = scrollable
        ? [
          <span class={['mz-tabs__nav-prev', scrollable.prev ? '' : 'is-disabled']} on-click={scrollPrev}><i class="mz-icon-arrow-left"></i></span>,
          <span class={['mz-tabs__nav-next', scrollable.next ? '' : 'is-disabled']} on-click={scrollNext}><i class="mz-icon-arrow-right"></i></span>
        ] : null;
      ...
      const tabs = this._l(panes, (pane, index) => {
        ...
        const btnClose = closable
          ? <span class="mz-icon-close" on-click={(ev) => { onTabRemove(pane, ev); }}></span>
          : null;
      ...
      return (
        <div class={['mz-tabs__nav-wrap', scrollable ? 'is-scrollable' : '', `is-${ this.rootTabs.tabPosition }`]}>
          {scrollBtn}
          <div class={['mz-tabs__nav-scroll']} ref="navScroll">
            <div class="mz-tabs__nav" ref="nav" style={navStyle} role="tablist" on-keydown={ changeTab }>
              {!type ? <mz-tab-bar tabs={panes}></mz-tab-bar> : null}
              {tabs}
            </div>
          </div>
        </div>
